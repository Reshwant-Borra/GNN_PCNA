...
# Run: pymol -c scripts/pymol/pcna_8gla_holo_pocket.py
#
# Pocket residue key:
...
# ── Fetch / load 8GLA ────────────────────────────────────────────────────────
raw_path = os.path.join(REPO_ROOT, "data", "raw", "8GLA.pdb")  # REPO_ROOT always absolute
...
cmd.remove("solvent")
cmd.remove("resn " + SOLVENT)
cmd.remove("resn " + IONS)
...
# ── Transparent surface: whole PCNA ring ─────────────────────────────────────
