...
def test_historical_phase3_composite_chain_parser_preserves_a_b():
    historical = Path(__file__).parent.parent / "archive" / "historical_desktop_gnn_pcna_202605_phase2_phase4" / "src"
    if not historical.exists():
        pytest.skip("historical phase3 code is not present in this checkout")
    sys.path.insert(0, str(historical))
    from phase3_data.labels import parse_target_chains
